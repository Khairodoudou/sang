...
export default function Signin() {
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center bg-gradient-to-b from-pink-50 to-white pt-24"
      dir="rtl"
    >
      <div className="bg-white container rounded-lg shadow-md p-6">
        ...
        <form className="space-y-8">
          ...
          <button
            type="submit"
            className="w-full bg-pink-500 hover:bg-pink-600 text-white rounded-md py-2 font-bold"
          >
            التسجيل
          </button>
          ...
          <p className="text-center text-gray-600 text-sm mt-2">
            ...
            <Link
              href="/Login"
              className="text-[#ec4261] font-semibold hover:underline"
            >
              تسجيل الدخول
            </Link>
          </p>
